...
class _RegisterState extends State<Register> {
      ...
      builder: (BuildContext context) {
        return PopScope(
          ...
          child: SimpleDialog(
            ...
            title: const Text('Seleccione su nivel de ingles',
                style: TextStyle(
                  fontFamily: "Fjalla",
                )),
            children: <Widget>[
  ...
  Future<void> _showSessionDialog(String userId) async {
    bool? interestedInSessions = await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return SimpleDialog(
          title: const Text('¿Está interesado en atender sesiones virtuales?',
              style: TextStyle(
                fontFamily: "Fjalla",
              )),
          children: <Widget>[
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        await _firestore
            ...
            .set({'email': email, 'username': username, 'level': 'unknown'});
